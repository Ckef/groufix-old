...
const long double GFX_MATH_RAD_TO_DEG  = 57.295779513082320876798154814105170332405472466564;
const long double GFX_MATH_DEG_TO_RAD  = 0.017453292519943295769236907684886127134428718885417;
